    ...
    <>
      ...
      >
        <div className="register-container flex-center contact">
          <h2 className="form-heading">Setup a Fundraiser</h2>
          <form className="register-form ">
            <input
              type="text"
              name="specialization"
              className="form-input"
              placeholder="Reason for Rasing Fund"
            ...
            <input
              ...
              name="experience"
              className="form-input"
              placeholder="Enter the target amount (in rupees)"
            ...
            <input
              ...
              name="fees"
              className="form-input"
              placeholder="Enter the reached amount (in rupees)"
